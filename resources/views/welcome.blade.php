...
@section('content')
    ...
    <section class="hero">
        ...
        <div class="hero-slider">
            ...
            <div class="hero-slide active" style="background-image: url('{{ secure_url('assets/img/banner_1_dashboard.png') }}');">
            ...
            <div class="hero-slide" style="background-image: url('{{ secure_url('assets/img/banner_2_daily_earnings.png') }}');">
                <div class="hero-slide-content">
            ...
            <div class="hero-slide" style="background-image: url('{{ secure_url('assets/img/banner_3_referrals.png') }}');">
                <div class="hero-slide-content">
